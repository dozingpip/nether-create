<recipetype:botania:terra_plate>.addRecipe("grisaia_for_wimps", <item:botania:infinite_fruit>, 20000, <item:minecraft:cake>,
<item:minecraft:pufferfish>, <item:botania:mana_cookie>, <item:create:sweet_roll>, <item:create:chocolate_glazed_berries>,
<item:create:honeyed_apple>, <item:create:builders_tea>);
<recipetype:botania:terra_plate>.addRecipe("king_key_for_wimps", <item:botania:king_key>, 20000, <item:storagedrawers:quantify_key>,
<item:combustivefishing:searing_sword>, <item:botania:star_sword>, <item:botania:flare_chakram>, <item:create:potato_cannon>);
