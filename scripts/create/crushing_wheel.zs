...
<recipetype:create:crushing>.addRecipe("powdered_obsidian", [<item:create:powdered_obsidian>], <item:pneumaticcraft:reinforced_bricks>);
<recipetype:create:crushing>.addRecipe("warped_fungus", [<item:minecraft:warped_fungus>], <item:minecraft:warped_wart_block>);
<recipetype:create:crushing>.addRecipe("crimson_fungus", [<item:minecraft:nether_wart> % 25, <item:minecraft:crimson_fungus>], <item:minecraft:nether_wart_block>);