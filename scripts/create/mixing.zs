<recipetype:create:mixing>.addRecipe("poisonous_potato", "heated", <item:minecraft:poisonous_potato>, [<item:minecraft:nether_wart>*4], [<fluid:create:milk>*1000,
...
<recipetype:create:mixing>.addRecipe("cake_overwrite", "heated", <item:minecraft:cake>, [<item:minecraft:sugar>*2, <item:minecraft:wheat>*3, <item:minecraft:egg>], [<fluid:create:milk>*3000]);
