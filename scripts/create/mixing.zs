...
<recipetype:create:mixing>.addRecipe("shulker_egg", "heated", <item:minecraft:shulker_spawn_egg>, [<item:minecraft:turtle_egg>, <item:minecraft:ender_chest>, <tag:items:botania:petals/purple>], [<fluid:tconstruct:blood>*1000]);
