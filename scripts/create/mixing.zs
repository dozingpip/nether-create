...
<recipetype:create:mixing>.addRecipe("piglin_egg", "heated", <item:minecraft:piglin_spawn_egg>, [<item:minecraft:turtle_egg>, <item:minecraft:gold_block>], [<fluid:tconstruct:blood>*500]);
...
<recipetype:create:mixing>.addRecipe("blood", "heated", <fluid:tconstruct:blood>*50, [<item:minecraft:rotten_flesh>], [], 10);
...
<recipetype:create:mixing>.addRecipe("cake_overwrite", "heated", <item:minecraft:cake>, [<item:minecraft:sugar>*2, <item:minecraft:wheat>*3, <item:minecraft:egg>], [<fluid:minecraft:milk>*1000]);
