...
mods.initialinventory.InvHandler.addStartingItem("nether-create guide", <item:patchouli:guide_book>.withTag({"patchouli:book": "patchouli:nethercreate" as string}));