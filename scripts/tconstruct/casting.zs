...
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("copper_nugget_gold_cast", <tag:items:tconstruct:casts/multi_use/ingot>, <fluid:tconstruct:molten_copper> * 16, <item:create:copper_nugget>, 17, false, false);
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("copper_nugget_sand_cast", <tag:items:tconstruct:casts/single_use/ingot>, <fluid:tconstruct:molten_copper> * 16, <item:create:copper_nugget>, 17, true, false);
